...
func main() {
	...
	api := r.Group("/api")
	{
		...
		api.GET("/writings/:id", handlers.GetWriting)
		api.POST("/writings/:id/like", handlers.LikeWriting)
		api.DELETE("/writings/:id/like", handlers.UnlikeWriting)
		api.GET("/writings/:id/comments", handlers.GetComments)
		api.POST("/writings/:id/comments", handlers.CreateComment)
