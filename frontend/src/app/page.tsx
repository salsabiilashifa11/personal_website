  ...
  return (
    <div className="space-y-16">
      ...
      <section className="pt-10">
        ...
        <h1 className="font-pixel text-2xl sm:text-3xl text-gray-900 dark:text-gray-100 leading-snug mb-6 flex items-center">
          Shifa
          <PixelCharacter />
        </h1>
          ...
          return (
            <div key={i} className="hidden dark:block space-y-3">
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className="font-pixel text-[9px] text-google-green"
              ...
              <p
                className="text-gray-200 leading-relaxed text-base bg-green-500/5 border border-green-500/10 rounded px-3 py-2"
